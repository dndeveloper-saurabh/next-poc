...
export const SidebarContextProvider = (props) => {
	...
	const [smallScreenIsAnswered, setsmallScreenIsAnswered] = useState(null);
	const [smallScreenSortBy, setsmallScreenSortBy] = useState("Recent first");

	const [queryParameters, setQueryParameters] = useState("");

	useEffect(() => {
		let b = JSON.parse(localStorage.getItem("isInstructor")) ? false : true;
		setsmallScreenIsAnswered(b);
		setIsAnswered(b);
	}, [])
